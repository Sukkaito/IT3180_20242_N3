...
-- Insert Fines
INSERT INTO fines (id, book_loan_id, amount, created_at)
VALUES
    ('1', '86621cd0-4fad-47d8-947e-bf1025afaedf', 50000, NOW() - INTERVAL '1 day'),
    ('2', '46c9dd3c-7a59-4928-a0e0-830aff62294b', 30000, NOW() - INTERVAL '3 days');
